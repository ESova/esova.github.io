...
function header (db, engine) {
  ...
  function onmouseover (event) {
    ...
    db.put(key, key+'--hover', function () {
      db.get('esova-credentials', function (error, credentials) {
        engine.push({
          type: 'vtree',
          key: 'header',
          value: renderHeader(error ? undefined : credentials)
        })
      })
    })
  }
      ...
      return h('div', { className: x('usernav') }, [
        ...
        h('div', {
          ...
          onclick: function (event) {
            event.preventDefault()
            auth(db, function (error, credentials) {
              // @TODO: think about action architecture in general
              // @TODO: the non-visual "auth module" might be used
              //        by several visual components.
              //        How should they communicate?
              db.put('AUTH', error, function (error) {
