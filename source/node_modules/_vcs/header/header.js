    ...
    h('div', { className: x('menubar') }, [
      ...
      h('div', { className: x('usernav') }, [
        ...
        h('div', { className: x('avatar') }, [
          h('div', { className: x('avatar-name') }, 'Pedja Rusic'),
          h('img', {
            ...
            onclick: function (event) {
              ...
              // @TODO: show again welcome page if promo became invalid
              // @TODO: TEST what happens if account is deleted...
              auth(db, function (error, token) {
                if (error) engine(error)
                db.put('esova-token', token, engine)
              })
