...
function validateChunk (chunk) {
  if (type((chunk||{}).value) === 'object' && (chunk||{}).type === 'vtree' ) {
    return true // @TODO: validate vtree
  }
  else {
    throw new Error('invalid vtree was piped to the engine: ' + chunk)
  }
}
