...
function ROUTER (db, urlRouting, dataRouting) {
  if (!router$) {
    ...
    function pagehandler (href, page) {
      ...
      ***********************************************************************/
      function render404(push) {
        var chat = 'https://gitter.im/ESova/esova.github.io/~embed'
        var style1 = {
          display: 'flex',
        ...
        var props = { style: style3, width:'100%', height:'100%', frameBorder:'0', src: chat }
        var vtree = h('div', { style: style1 }, [
          h('h1', '404 - ERROR'),
          h('h2', 'Please use the chat & tell us about it, so we can fix it'),
          h('div', { style: style2 }, [
            h('iframe', props)
          ])
        ])
      ...
      route ? route.fn(push) : render404(push)
