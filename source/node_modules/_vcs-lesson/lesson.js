  ...
  function renderQuestion (slide, next) {
    var vtree = h('div', { className: x('videopopup-question')}, [
      ...
      h('div', { className: x('answers')}, [
        h('input', { type: 'checkbox', name: 'option1', className: x('answer'), value: slide.options[0] }), slide.options[0],
        h('input', { type: 'checkbox', name: 'option2', className: x('answer'), value: slide.options[1] }), slide.options[1],
        h('input', { type: 'checkbox', name: 'option3', className: x('answer'), value: slide.options[2] }), slide.options[2],
        h('input', { type: 'checkbox', name: 'option4', className: x('answer'), value: slide.options[3] }), slide.options[3]
      ])
    ])
    return vtree
  }
