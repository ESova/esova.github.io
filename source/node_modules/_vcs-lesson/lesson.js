...
function LessonComponent (db, engine) {
          ...
          video.bind("secondchange", function() {
            ...
            db.get('esova-lesson', function (error, lesson){
              if (slides) {
                ...
                show(slide, lesson||'0', function next () {
                  var slide = slides.shift()
                  if (slide) show(slide, lesson||'0', next)
                  else video.play()
                })
              }
            })
  ...
  function show (slide, lesson, next) {
    var vtree = TYPE[slide.type](slide, lesson, next)
    engine.push({
      type: 'vtree',
      key: 'videopopup',
  ...
  function renderQuestion (slide, lesson, next) {
