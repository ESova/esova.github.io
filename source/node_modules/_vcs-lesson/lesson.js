...
function LessonComponent (db, engine) {
      ...
      h('div', {
        ...
        onclick: function (event) {
          if (lesson === '0') {
            ...
            window.open(slide.link.url, '_blank')
            next() // which should open a SOLUTION SLIDE
          }
        }
      }, [
  ...
  function renderBravo (slide, lesson, render, next) {
    debugger
    // @TODO: remove random "bravo" appearing on mainscreen
    // @TODO: add continue buttons on SOLUTION slide
    // @TODO: advance lastLesson state on video end if question answers success
    // @TODO: proof question answers and fail if they are WRONG
    // @TODO: check waffle todos
    STATUS.solved += 1
    ...
    function doBravo () {
      ...
      var vtree = h('div', {
        ...
        LOCALE['text/lesson/slide/bravo']
      ])
      render(vtree)
    }
  }
  ...
  function renderTryAgain (slide, lesson, render, next) {
    ...
    var vtree = h('div', {
      ...
      LOCALE['text/lesson/slide/tryagain']
    ])
    render(vtree)
  }
